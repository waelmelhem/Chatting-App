...
<body>
                                ...
                                @foreach ($friendes as $friend)
                                    <div class="card-list">
                                        ...
                                        @if ($last != $curr)
                                            <div class="my-5">
                                                <small
                                                    class="text-uppercase text-muted">{{ strtoupper($curr) }}</small>
                                            </div>
                                            @php($last = $curr)
                                        @endif
                                        <!-- Card -->
                                        ...
                                        <a href="chat-group.html" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <img src="{{asset()}}" alt="#" class="avatar-img">
                                                        </div>
                                                    </div>
        ...
        <main class="main is-visible" data-dropzone-area="">
            <div class="container h-100">
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    ...
                    <!-- Chat: Content -->
                    <div class="chat-body hide-scrollbar flex-1 h-10">
                        <div class="chat-body-inner">
                            <div class="py-6 py-lg-12" id="chat_body">
                                @php($last = '')
                                @foreach ($messages as $message)
                                    @php($current = $message->created_at->format('Y-m-d'))
                                    @if ($last != $current)
                                        <!-- Divider -->
                                        <div class="message-divider">
                                            <small
                                                class="text-muted">{{ $message->created_at->format('D,M-Y') }}</small>
                                        </div>
                                        @php($last = $current)
                                    @endIf
                                    ...
                                    @if (Auth::id() != $message->user_id)
                                        <div class="message">
                                            <a href="#" data-bs-toggle="modal"
                                                ...
                                                <img class="avatar-img"
                                                    src="{{ asset('assets/img/avatars/2.jpg') }}" alt="">
                                            </a>
                                            ...
                                            <div class="message-inner">
                                                ...
                                                <div class="message-footer">
                                                    <span
                                                        class="extra-small text-muted">{{ $message->created_at->format('h:i a') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="message message-out">
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#modal-profile" class="avatar avatar-responsive">
                                                <img class="avatar-img"
                            ...
                            <script>
                                $("#chat_body").animate({ scrollTop: "300px" });
                            </script>
                        </div>
                    </div>
                    <!-- Chat: Content -->
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="post"
                            ...
                            @csrf
                            <input  type="text" value="{{$current1}}" name="conversation_id" hidden />
                            <div class="row align-items-center gx-0">
                                <div class="col-auto">
    ...
    <script>
        ...
        var pusher = new Pusher('b429c2bb86388a17e2f7', {
            cluster: 'eu',
