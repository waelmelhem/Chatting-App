                                    ...
                                    <!-- List -->
                                        ...
                                        @foreach ($friendes as $friend)
                                            <div class="card-list">
                                                ...
                                                @if ($last!=$curr)
                                                    <div class="my-5">
                                                        <small class="text-uppercase text-muted">{{ strtoupper($curr)}}</small>
                                                    </div>
                                                    @php($last=$curr)
                                                @endif
                                                <!-- Card -->
                                                        ...
                                                        <div class="row align-items-center gx-5">
                                                            <div class="col-auto">
                                                                <a href="#" class="avatar ">
                                                                    ...
                                                                    <img class="avatar-img" src="{{asset($friend->avatar_url)}}" alt="">
                                        ...
                                        <a href="{{route("messenger",$chat->id)}}" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <span class="avatar-text">{{$chat->participants[0]->name[0]}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-3">
                                                            ...
                                                            <span class="text-muted extra-small ms-2">{{($chat->last_message->created_at->diffForHumans())}}</span>
                                                        </div>
                        ...
                        <div class="row gy-6">
                            <div class="col-12">
                                <div class="avatar avatar-xl mx-auto">
                                    <img src="{{asset('assets/img/avatars/2.jpg')}}" alt="#" class="avatar-img">
                                        ...
                                        <div class="col-auto">
                                            <div class="avatar-group">
                                                <a href="#" class="avatar avatar-sm">
                                                    <img src="{{asset('assets/img/avatars/2.jpg')}}" class="avatar-img" alt="#">
                                                </a>
